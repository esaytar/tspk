                            ...
                            <table className='border-spacing-2 table-fixed text-[1.14rem] lg:text-18'>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className='lg:p-10 p-[1.43rem] bg-white relative text-left align-baseline'><a className='underline' href="https://tspk.org/images/oficial_dokument_2023/fond_pensonnogo_i_soc_stahovania_2023.pdf">Акт выездной проверки</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td className='p-10 bg-white relative align-baseline'><a className='underline' href="https://tspk.org/images/oficial_dokument_2023/reshenie_o_provedenii_proverki_2023.pdf">Решение о проведении проверки</a></td>
                                        <td className='p-10 bg-white relative align-baseline'><a className='underline' href="https://tspk.org/images/oficial_dokument_2023/Predstavlenie_TSPK_214-23-213.pdf">Представление об устранении нарушений</a></td>
                                    </tr>
                                    <tr> 
                                        <td className='p-10 bg-white relative align-baseline'>Прокуратора Комсомольского района г. Тольятти</td>
                                        ...
                                        <td className='p-10 bg-white relative align-baseline'><a className='underline' href="https://tspk.org/images/oficial_dokument_2023/Trebovanie_562-23-213.pdf">Требование</a></td>
